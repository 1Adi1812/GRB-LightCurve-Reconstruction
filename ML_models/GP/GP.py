...
# https://jamesmccaffrey.wordpress.com/2023/05/30/using-pairwisekernel-in-scikit-gaussianprocessregressor-for-polynomial-kernel/
# kernel = PairwiseKernel(metric='poly', pairwise_kernels_kwargs={'degree':10})
...
plt.savefig('/path/to/your/results/'+str(GRB_Name)+".png", dpi=300)
plt.show()
...
df.to_csv('/path/to/your/results/'+str(GRB_Name)+'.csv')
